...
<body>
    ...
    <div id="page-wrapper">
        <div class="navbar-default sidebar" role="navigation1" id="userTable" aria-hidden="false" style="width: 500px;">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu1">
                <#list answers as l>
                    <li id="col1">
                        <a href="#"><i class="fa dashboard fa-fw"></i> Q: ${l.title}</a>
                        <#list l.options as o>
                            <a href="#"><i class="fa dashboard fa-fw""></i>A: ${o}</a>
                        </#list>
                    </li>
                </#list>
                </ul>
