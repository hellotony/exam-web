...
var Kalendae = function (targetElement, options) {
	...
	while (j--) {
		...
		var prev = util.make('a', {'class':classes.previousMonth}, $title);          //previous button
		//util.make('i', {'class':'fa fa-chevron-left'}, prev);//向左箭头
		util.make('a', {'class':classes.nextYear}, $title);               //next button
		var _next = util.make('a', {'class':classes.nextMonth}, $title);              //next button
		//util.make('i', {'class':'fa fa-chevron-right'}, _next);//向右箭头
...
(function (undefined) {
    ...
    ************************************/
    ...
    Language.prototype = {
        ...
        //_months : "January_February_March_April_May_June_July_August_September_November_December".split("_"),
