...
(function(d) {
    ...
    d.widget("ech.multiselect", {
        ...
        _create: function() {
            ...
            this._isOpen = !1;
            a = (this.button = d('<button type="button"><span class="down-icon"><i class="fa fa-chevron-down"></i></span></button>')).addClass("ui-multiselect ui-widget ui-state-default ").addClass(b.classes).attr({
                title: a.attr("title"),
                "aria-haspopup": !0,
                tabIndex: a.attr("tabIndex")
            }).insertAfter(a); (this.buttonlabel = d("<span />")).html(b.noneSelectedText).appendTo(a);
            var a = (this.menu = d("<div />")).addClass("ui-multiselect-menu ui-widget ui-widget-content ").addClass(b.classes).appendTo(document.body),
            c = (this.header = d("<div />")).addClass("ui-widget-header  ui-multiselect-header ui-helper-clearfix").appendTo(a); (this.headerLinkContainer = d("<ul />")).addClass("ui-helper-reset").html(function() {
                return ! 0 === b.header ? '<li><a class="ui-multiselect-all" href="#"><span class="ui-icon ui-icon-check"></span><span class="btn btn-green">' + b.checkAllText + '</span></a></li><li><a class="ui-multiselect-none" href="#"><span class="ui-icon ui-icon-closethick"></span><span class="btn btn-delete">' + b.uncheckAllText + "</span></a></li>": "string" === typeof b.header ? "<li>" + b.header + "</li>": ""
            }).append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close btn btn-close" style="text-decoration: none;">关闭</a></li>').appendTo(c); (this.checkboxContainer = d("<ul />")).addClass("ui-multiselect-checkboxes ui-helper-reset").appendTo(a);
            this._bindEvents();
            this.refresh(!0);
            ...
            b.find("option").each(function(b) {
              ...
              /*  e += '<input id="' + b + '" name="multiselect_' + i + '" type="' + (c.multiple ? "checkbox": "radio") + '" value="' + k + '" title="' + f + '"';
                ...
                */
                ...
                //判断是属于checkbox还是radio
                var type = c.multiple ? "checkbox": "radio";
                
                	/*<div class="radio-wrapper">
                	<input type="radio" value="${tourist_index}" name="personType"  />
                	<div class="radio-inner"><span></span></div>
                	<div class='radio-text'>是</div>
                </div>*/
                e += '<div class="'+type+'-wrapper"><input id="' + b + '" name="multiselect_' + i + '" type="' + type + '" value="' + k + '" title="' + f + '"';
                n && (e += ' checked="checked"', e += ' aria-selected="true"');
                l && (e += ' disabled="disabled"', e += ' aria-disabled="true"');
                e += " /><div class='"+type+"-inner'><span></span></div><div class='"+type+"-text'>" + f + "</div></label></li>"
            });
            h.html(e);
        ...
        update: function() {
            ...
            a = 0 === f ? a.noneSelectedText: d.isFunction(a.selectedText) ? a.selectedText.call(this, f, b.length, c.get()) : /\d/.test(a.selectedList) && 0 < a.selectedList && f <= a.selectedList ? c.map(function() {
                return /*d(this).next().html()*/ d(this).siblings("div[class*=text]").html()
