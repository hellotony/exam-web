 ...
 */
public class MultipleDataSourcesTransactionManager extends AbstractPlatformTransactionManager implements
        InitializingBean {
	...
	public MultipleDataSourcesTransactionManager() {
		super();
		/**
		 * 防止重复初始化事务同步管理器
		 * 
		 * @see TransactionSynchronizationManager#initSynchronization
		 */
