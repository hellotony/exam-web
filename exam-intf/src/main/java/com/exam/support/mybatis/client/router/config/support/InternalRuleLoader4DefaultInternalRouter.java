 ...
 */
package com.exam.support.mybatis.client.router.config.support;
...
public class InternalRuleLoader4DefaultInternalRouter {
	...
	private List<Set<IRoutingRule<IBatisRoutingFact, List<String>>>> setUpRuleSequenceContainerIfNecessary(
		...
		List<Set<IRoutingRule<IBatisRoutingFact, List<String>>>> ruleSequence = routerToUse.getRulesGroupByNamespaces()
				.get(namespace);
