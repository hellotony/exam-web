...
public class CobarDataSourceDescriptor {
	 ...
	 * datasource自动生成时的索引号
	 */
	private int index = CobarConstants.DEFAULT_DATASOURCE_INDEX;
	/**
	 * active data source
	 */
	...
	public String toString() {
		return "CobarDataSourceDescriptor [identity=" + identity + ", poolSize=" + poolSize + ", standbyDataSource="
				+ standbyDataSource + ", standbyDetectorDataSource=" + standbyDetectorDataSource
				+ ", targetDataSource=" + targetDataSource + ", targetDetectorDataSource=" + targetDetectorDataSource
				+ "]";
	}
